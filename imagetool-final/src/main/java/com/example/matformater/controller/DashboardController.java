...
//        stage.show();
    ...
    private void changeFormatButtonPressed(ActionEvent actionEvent) throws IOException {
        ...
        String q = "../views/change-photo-format.fxml";
        Object a = getClass().getResource(q);
        Pane changePhotosFormatPane = FXMLLoader.load(getClass().getResource("../views/app-dashboard.fxml"));
